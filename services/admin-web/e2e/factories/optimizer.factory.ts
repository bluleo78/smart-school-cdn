...
import type { OptimizerProfile, DomainStats } from '../../src/api/optimizer';

/** 최적화 프로파일 목록 생성 (2건) */
export function createProfileList(): OptimizerProfile[] {
  return [
...
/** 도메인별 절감 통계 목록 생성 (2건) */
export function createStatsList(): DomainStats[] {
  return [
