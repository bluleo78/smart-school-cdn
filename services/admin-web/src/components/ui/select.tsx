/** Select 컴포넌트
 * shadcn/ui 스타일 호환 — @radix-ui/react-select 래퍼
 */
...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      // cn(): tailwind-merge로 호출부 className(예: w-48)이 베이스 w-full을 덮도록 보장
      className={cn(
...
export function SelectSeparator({
  className = '',
  ...props
}: SelectPrimitive.SelectSeparatorProps & { className?: string }) {
  return (
